...
ifeq ($(shell uname), Darwin) # Mac OS
	FILES = main map signal_handler library ConfigParser File Server Server_OS__singleClient Request Response Connection Webserv_Exceptions
...
# FILES = main map signal_handler library ConfigParser ConfigFile Server Server_OS__singleClient Request Response Connection Webserv_Exceptions
	...
	FILES = main map signal_handler library ConfigParser File Server Server_OS__linux Request Response Connection Webserv_Exceptions
