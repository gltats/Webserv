...
ifeq ($(shell uname), Darwin) # Mac OS
	FILES = main signal_handler library ConfigParser ConfigFile File AServer Server_OS__singleClient Request Response Connection Webserv_Exceptions
...
# FILES = main map signal_handler library ConfigParser ConfigFile Server Server_OS__singleClient Request Response Connection Webserv_Exceptions
	...
	FILES = main signal_handler library ConfigParser ConfigFile  File AServer Server_OS__linux Request Response Connection Webserv_Exceptions
